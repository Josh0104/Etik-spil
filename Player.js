...
move() {
  ...
  image(this.imgPlayer,this.Player_X,this.Player_Y,this.widthPlayer,this.heightPlayer);
    ...
    if (keyIsDown(RIGHT_ARROW) && this.Player_X < width/2 + 150 || keyIsDown(68) && this.Player_X < width/2 + 150) {
        this.Player_X += this.speed;

      } else if (keyIsDown(LEFT_ARROW) && this.Player_X > width/2 - 300 || keyIsDown(65) && this.Player_X > width/2 - 300) {
        this.Player_X -= this.speed;
      
      }//else if (keyIsDown(UP_ARROW) && this.Player_Y > 0 || keyIsDown(87) && this.Player_Y > 0) {
      //   this.Player_Y -= this.speed;

      // } else if (keyIsDown(DOWN_ARROW) && this.Player_Y < height - this.heightPlayer || keyIsDown(83) && this.Player_Y < height - this.heightPlayer ) {
      //   this.Player_Y += this.speed;
      // }
